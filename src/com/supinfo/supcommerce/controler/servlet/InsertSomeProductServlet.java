						...
						+ "<div class=\"container\">"
							...
							+ "<nav class=\"navbar-collapse collapse\" style=\"height: 0.8px;\">"
								+ "<ul class=\"nav navbar-nav\">"
									...
									+ "<li class=\"active\"><a href=\"/SupCommerce-3-1/auth/basicInsert\"><span class=\"glyphicon glyphicon-random\"></span>&nbsp; Random Product</a></li>"
								+ "</ul>"
							+ "</nav>"
						+ "</div>"
					+ "</div>"
							...
							+ "<div class=\"col-sx-12 col-sm-6 col-md-4 col-lg-3\">"
								+ "<article class=\"panel panel-primary\">"
									+ "<header class=\"panel-heading\">"
										+ "<h3><a style=\"color: #FFF;\" href=\"/SupCommerce-3-1/showProduct?id=" + Long.toString(product.getId()) + "\"><span class=\"glyphicon glyphicon-tag\"></span>&nbsp; Product Id " + Long.toString(product.getId()) + "</a></h3>"
									+ "</header>"
