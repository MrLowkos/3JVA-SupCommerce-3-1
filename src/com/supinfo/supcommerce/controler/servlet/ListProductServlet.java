 						...
 						+ "<div class=\"container\">"
 							...
 							+ "<nav class=\"navbar-collapse collapse\" style=\"height: 0.8px;\">"
 								+ "<ul class=\"nav navbar-nav\">"
 									...
 									+ "<li class=\"active\"><a href=\"/SupCommerce-3-1/listProduct\"><span class=\"glyphicon glyphicon-list\"></span>&nbsp; Products List Servlet</a></li>"
									...
									out.println(
										...
										+ "<article class=\"panel panel-primary\">"
											+ "<header class=\"panel-heading\">"
												...
												+ "<h3><a style=\"color: #FFF;\" href=\"/SupCommerce-3-1/showProduct?id=" + Long.toString(p.getId()) + "\">"
													+ "<span class=\"glyphicon glyphicon-tag\"></span>&nbsp; Product Id " + Long.toString(p.getId())												
												+ "</a></h3>"
											+ "</header>"
											+ "<section class=\"panel-body\">"
												+ "<p>Name: " + p.getName() + "</p>"
												+ "<p>Description: " + p.getContent() + "</p>"
